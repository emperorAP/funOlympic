...
<body>
    ...
    <header class="headder">
        <nav id="navi" class="navbar">
            ...
            <div class="left-nav">
                <ul class="left-part">
                    <li id="ho"><a href="home.php">HOME</a></li>
                    <li><a href="watchlive.php">WATCH LIVE</a></li>
                    <li id=""><a href="news.php">NEWS</a></li>  
                </ul>
                <ul class="right-part">
                    <li class="login-area"><a href="logout.php">LOGOUT</a></li>
                </ul>
            </div>
    ...
    <div class="form-container">
        <div class="wrapper">
           <img style="margin-left: -2rem;" src="https://wp.inews.co.uk/wp-content/uploads/2021/08/PRI_192753674.jpg?resize=760,507&strip=all&quality=90" alt="Olympics" srcset="">
        </div>
        <style>
        </style>
        <div class="butn">
